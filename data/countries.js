const countries = [
  ...
  },
  {
    ...
    emblemImage: { url: "../../assets/images/destinations/french-guiana-heraldic-arms.svg", alt: "סמל גיאנה הצרפתית", credit: "סמל מקומי בפרויקט", source: "assets/images/destinations/french-guiana-heraldic-arms.svg" },
    explorer: "מסעות צרפתיים ואירופיים לאורך חוף הגיאנות",
    explorerEnglish: "French and European voyages along the Guianas coast",
    explorerLifeYears: "המאה ה־16 ואילך",
    explorerImage: { url: "../../assets/images/destinations/cayenne-city-8525272038.jpg", alt: "קאיין, גיאנה הצרפתית", credit: "תמונה מקומית בפרויקט", source: "assets/images/destinations/cayenne-city-8525272038.jpg" },
    discoveryYear: "המאה ה־16",
  ...
  },
  {
    ...
    discoveryYear: "1500 ואחר כך 1541–1542",
    discoveryCircumstances: "פינסון מזוהה עם הגעה אירופית מוקדמת לשפך האמזונס, ואוריאנה עם המסע לאורך הנהר והפצת השם אמזונס.",
    indigenousPeoples: "לפני הגעת האירופים חיו באזור עמים ילידיים רבים לאורך הנהרות, האיים, היערות והחופים.",
    etymology: "השם אמזונס נקשר למסעו של אוריאנה ולדימוי האמזונות מן המיתולוגיה היוונית, לצד שמות מקומיים קדומים לנהר.",
