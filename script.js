...
const timelineEvents = [
  { year: "1451", title: "ילדותו של כריסטופר קולומבוס", location: "גנואה, איטליה", summary: "קולומבוס נולד בגנואה למשפחה עירונית פשוטה יחסית, בסביבה ימית ומסחרית פעילה.", details: "כריסטופר קולומבוס נולד ככל הנראה בשנת 1451 בגנואה. אביו עסק במלאכות ובמסחר, והעיר שבה גדל הייתה מרכז ימי חשוב. הסביבה הימית של גנואה, קשריה המסחריים והמפגש עם יורדי ים תרמו לעיצוב דמיונו ותחומי העניין שלו כבר מגיל צעיר." },
  ...
  { year: "1492", title: "קולומבוס מגיע להיספניולה", location: "היספניולה", summary: "קולומבוס מגיע לאי גדול ומיושב, שבו תוקם לה נבידד.", details: "היספניולה הייתה אחד המקומות החשובים ביותר במסעו הראשון של קולומבוס. לאחר שאוניית סנטה מריה עלתה על שרטון, הוקמה באי לה נבידד — ההתיישבות הספרדית הראשונה באמריקה." },
  ...
  { year: "1498–1500", title: "המסע השלישי של קולומבוס", location: "טרינידד וחופי אמריקה הדרומית", summary: "קולומבוס מגיע לאזור טרינידד ולחופי ונצואלה.", details: "במסעו השלישי הגיע קולומבוס לאזורים דרומיים יותר של העולם החדש. המסע חיזק את ההבנה שהאזורים שהתגלו אינם רק איים בודדים, אלא חלק ממרחב יבשתי וגאוגרפי עצום." },
  ...
  { year: "1504", title: "תחילת דרכו של קורטס בעולם החדש", location: "היספניולה", summary: "קורטס מגיע לעולם החדש ומתחיל את דרכו כמנהל ומתיישב.", details: "הרנאן קורטס הגיע להיספניולה בראשית המאה ה־16. שם החל לצבור ניסיון במנהל קולוניאלי, קשרים פוליטיים והבנה של מנגנוני הכוח הספרדיים בעולם החדש. זו הייתה תחילת דרכו לפני עלייתו הגדולה במקסיקו." },
  { year: "1506", title: "מות קולומבוס", location: "ויאדוליד, ספרד", summary: "קולומבוס נפטר לאחר מסעותיו, בעוד משמעות תגליותיו עדיין מתבררת.", details: "קולומבוס נפטר בשנת 1506 בספרד. אף שבימיו עדיין הייתה אי־בהירות לגבי משמעות התגליות, מסעותיו שינו את ההיסטוריה העולמית ופתחו עידן חדש של קשרים, כיבושים, מסחר, הגירה ועימותים בין יבשות." },
  { year: "1511", title: "כיבוש קובה", location: "קובה", summary: "ספרד מעמיקה את שליטתה בקריביים וקורטס משתתף בכיבוש קובה.", details: "כיבוש קובה חיזק את מעמדה של ספרד בקריביים. קורטס צבר שם ניסיון פוליטי וצבאי, והאי הפך לנקודת מוצא למסעות נוספים אל מקסיקו." },
  { year: "1513", title: "פונסה דה לאון מגיע לפלורידה", location: "פלורידה", summary: "פונסה דה לאון מביא את חופי פלורידה לידיעת ספרד.", details: "פונסה דה לאון הגיע לחופי פלורידה בשנת 1513. המסע הרחיב את המבט הספרדי מן האיים הקריביים אל חופי צפון אמריקה, והוסיף ידע חשוב על זרמי ים ונתיבי שיט." },
  { year: "1513", title: "בלבואה רואה את הים הדרומי", location: "פנמה", summary: "ואסקו נונייס דה בלבואה חוצה את מצר פנמה ורואה את האוקיינוס השקט.", details: "בלבואה חצה את אזור פנמה בעזרת מידע מקומי וראה את האוקיינוס השקט מן הצד האמריקאי. הגילוי האירופי הזה הראה שממערב לאמריקה נמצא אוקיינוס עצום נוסף." },
  ...
  { year: "1520", title: "לה נוצ'ה טריסטה", location: "טנוצ'טיטלאן", summary: "הספרדים נסוגים מטנוצ'טיטלאן בלילה קשה לאחר עימותים עם המֶשיקה.", details: "לה נוצ'ה טריסטה, 'הלילה העצוב', הייתה נקודת משבר במסע קורטס. הכוחות הספרדיים ובעלי בריתם נאלצו לסגת מטנוצ'טיטלאן לאחר קרבות קשים ואבדות." },
  ...
  { year: "1521", title: "מות מגלן בפיליפינים", location: "האי מקטאן", summary: "מגלן נהרג בפיליפינים, אך משלחתו ממשיכה את המסע סביב העולם.", details: "מגלן נהרג בקרב מקטאן בשנת 1521. אף שלא השלים את מסע ההקפה בעצמו, המשלחת המשיכה מערבה ובסופו של דבר שבה לספרד." },
  ...
  { year: "1532", title: "פיסארו ולכידת אטוואלפה", location: "קחמרקה, פרו", summary: "פרנסיסקו פיסארו לוכד את אטוואלפה, שליט האינקה.", details: "לכידת אטוואלפה בשנת 1532 הייתה נקודת מפנה בכיבוש הספרדי של אימפריית האינקה. האירוע התרחש על רקע מתחים פנימיים באימפריה, עליונות טכנולוגית ספרדית ובריתות פוליטיות מורכבות." },
  ...
  { year: "1541", title: "מות פרנסיסקו פיסארו", location: "לימה", summary: "פיסארו נרצח בלימה על רקע סכסוכים בין הכובשים הספרדים.", details: "לאחר כיבוש פרו התגלעו סכסוכים חריפים בין פיסארו לבין תומכי דייגו דה אלמגרו. בשנת 1541 נרצח פיסארו בלימה, והאירוע המחיש את האלימות הפנימית בעולם הקונקיסטאדורים." },
  { year: "1547", title: "מות הרנאן קורטס", location: "ספרד", summary: "קורטס נפטר בספרד לאחר שנים של מאבקים על מעמדו וזכויותיו.", details: "קורטס מת בשנת 1547. דמותו נותרה שנויה במחלוקת: מצד אחד הוא נתפס ככובש ומנהיג צבאי יוצא דופן, ומצד שני כמי שעמד במרכז תהליך אלים של כיבוש, הרס תרבותי ושינוי עמוק בחיי העמים הילידיים." }
];
...
function createCountryCard(country) {
  ...
  card.querySelector("button").addEventListener("click", () => {
    if (country.detailPage) window.location.href = country.detailPage;
    else openCountryModal(country);
  });
  return card;
}
...
function renderCountries() {
  ...
  countries.forEach((country) => countryGrid.appendChild(createCountryCard(country)));
}
...
function renderTimeline() {
  ...
  timelineEvents.forEach((event) => timelineGrid.appendChild(createTimelineCard(event)));
}
